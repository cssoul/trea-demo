<template>
  <div class="toolbar">
    ...
    <div class="toolbar-section tools">
      ...
      <a-tooltip title="连线配置">
        <button class="tbtn" @click="$emit('link-config')">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 17c3 0 5-10 9-10s6 10 9 10"/><circle cx="4" cy="17" r="1.6" fill="currentColor"/><circle cx="20" cy="17" r="1.6" fill="currentColor"/></svg>
        </button>
      </a-tooltip>
...
defineEmits(['undo', 'redo', 'toggle-link', 'delete', 'zoom-in', 'zoom-out', 'fit', 'save', 'preview', 'link-config'])
